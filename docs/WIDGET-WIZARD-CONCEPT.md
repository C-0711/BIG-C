...
## Konzept-Dokument v1.1
**Datum:** 2026-02-08  
**Status:** DRAFT - Awaiting Approval  
**Änderung v1.1:** Deployment-Architektur aktualisiert, Reusable Templates Konzept
...
- [ ] Create `Widget` base class/component
- [ ] Define widget lifecycle hooks (mount, update, destroy)
- [ ] Implement widget state management
- [ ] Add widget error boundary
- [ ] Write unit tests
**Estimate:** 4h | **Priority:** P0

### WF-002: Widget Registry
- [ ] Create widget type registry
- [ ] Implement widget factory pattern
- [ ] Add widget type validation
- [ ] Support lazy loading of widget code
**Estimate:** 3h | **Priority:** P0

### WF-003: Widget Config Schema
- [ ] Define JSON Schema for widget configuration
...
- [ ] Add wildcard subscription support (e.g., "product.*")
**Estimate:** 3h | **Priority:** P0

### EB-002: Event Queue
- [ ] Create in-memory event queue
- [ ] Implement FIFO processing
- [ ] Add event deduplication (optional)
- [ ] Add event history (last N events)
...
- [ ] Add useWidgetEvents() hook
- [ ] Auto-subscribe based on widget type
